...
namespace ExtraAssignments.OlesExtra.Yatzy
{
    public class YatzyIMPL
    {
        ...
        private DiceCupIMPL _diceCup = new();
        private int[] _currentRoll = new int[5];
        private int[,] _scoreBoard = new int[15, 4];
        private bool[,] _usedRule = new bool[15, 4];
        ...
        public YatzyIMPL(int numberOfPlayers)
        {
            ...
            _scoreBoard = new int[15, numberOfPlayers];
            _usedRule = new bool[15, numberOfPlayers];
        ...
        public int getPointsRule(int id, int rule)
        {
            return _scoreBoard[rule, id];
        }
        ...
        public void awardPoints(int rule)
        {
            ...
            _usedRule[rule - 1, _playerInTurn] = true;
        }
    }
}
